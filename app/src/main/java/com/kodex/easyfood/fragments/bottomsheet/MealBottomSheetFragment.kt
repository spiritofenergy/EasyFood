package com.kodex.easyfood.fragments.bottomsheet
...
import com.kodex.easyfood.databinding.FragmentMealBottonSeetBinding
...
class MealBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private lateinit var binding: FragmentMealBottonSeetBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMealBottonSeetBinding.inflate(inflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        onBottomShiteDialogClick()
    }

    private fun onBottomShiteDialogClick() {
